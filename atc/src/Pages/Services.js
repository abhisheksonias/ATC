...
//         'SEO optimization for discoverability'
//       ],
//       videoUrl: "https://drive.google.com/file/d/1j80PrWzbs1y_cZheQdylCBW9imPjdnyu/preview"
//     },
//     {
//       title: 'Thumbnail Designing',
//       description: 'Stand out in crowded feeds with eye-catching thumbnails that drive clicks and increase video performance.',
...
//                     whileTap={{ scale: 0.9 }}
//                   >
//                     {service.videoUrl.includes('drive.google.com') ? (
//                       <iframe
//                         src={`${service.videoUrl}?autoplay=0&mute=1&loop=1&rel=0&modestbranding=1`}
...
//                         loading="lazy"
//                         onLoad={() => console.log(`${service.title} video loaded`)}
//                       />
//                     ) : (
//                       <video
//                         src={service.videoUrl}
